...
def register(bot):
    ...
    bot.listen(r'^bless (.*)$', bless_someone)
...
def bless_someone(bot, msg):
    ...
    msg.respond('Blessed be {}, in the name of the compiler, the linker, and the holy runtime!'.format(msg.match.group(1)), ping=False)
